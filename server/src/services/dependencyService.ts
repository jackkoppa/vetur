...
export class DependencyService {
  ...
  async init(workspacePath: string, useWorkspaceDependencies: boolean, tsdk: string) {
    if (!useWorkspaceDependencies) {
      ...
      const workspaceTSPath = tsdk ? tsdk : path.resolve(workspacePath, 'node_modules/typescript');
